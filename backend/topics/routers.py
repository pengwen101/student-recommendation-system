...
@topics_router.get("", response_model=AllTopicsResponse, dependencies=[Depends(require_any())])
...
@topics_router.get("/{topic_id}", response_model=TopicDetailsResponse, dependencies=[Depends(require_any())])
...
@topics_router.post("", response_model=TopicDetailsResponse, dependencies=[Depends(require_admin())])
...
@topics_router.put("/{topic_id}", response_model=TopicDetailsResponse, dependencies=[Depends(require_admin())])
...
@topics_router.delete("/{topic_id}", dependencies=[Depends(require_admin())])
